...
export class TokenService {
    ...
    signAccessToken(payload: { userId: string, roleId?: number, verify?: number }) {
    ...
    signRefreshToken(payload: { userId: string, roleId?: number }) {
        return this.jwtService.sign(payload, {
    ...
    signAccessAndRefreshToken(payload: { userId: string, roleId?: number, verify: number }) {
        return Promise.all([
